resource "kubernetes_secret" "etcd" {
  ...
  # scp root@192.168.2.121:/etc/kubernetes/pki/etcd/ca.crt               .certs/ca.crt

  # cat /etc/kubernetes/pki/apiserver-etcd-client.crt
  # scp root@192.168.2.121:/etc/kubernetes/pki/apiserver-etcd-client.crt .certs/apiserver-etcd-client.crt
